...
body {
  ...
  width: 100%;
  height: 100%;
  overflow-x: hidden; /* Ngừng hiển thị thanh cuộn ngang */
}

/* Đảm bảo màu nền của body là đen */
body {
  font-family: "Quicksand", sans-serif;
  display: flex;
...
section::before {
  ...
  z-index: -1; /* Đảm bảo nền động nằm dưới các phần tử khác */
}
...
/* Cấu hình cho các phần tử trong section */
